...
import 'package:e_commerce_app/view/checkout_view.dart';
...
class _WishlistState extends ConsumerState<Cart> {
  ...
  final TextStyle _style = TextStyle(fontSize: 36, fontWeight: FontWeight.bold);
